...
# Select only relevant features with high correlation as shown in explore_students.ipynb
X_student = X_student[['Tuition fees up to date','Curricular units 1st sem (approved)',
